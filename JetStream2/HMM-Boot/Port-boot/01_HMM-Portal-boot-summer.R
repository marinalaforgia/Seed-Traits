...
# according to the metadata 2003 and 2009 were both done... https://github.com/weecology/PortalData/blob/main/Plants/Portal_plant_censuses.csv
...
saveRDS(boot.df, "port-species-boot-summer.RDS")
